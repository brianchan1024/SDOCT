...
private:
	...
	vector<float> dispParam, a2;					// dispParam holds A2, A3, 0, 0. 
	float2 *fphi, *d_fringe_interp, *d_fringe_frame;
	vector<int> ROIbounds, w;
	...
	void thirdOrder();								// 
	void getParam(int it, vector<float> &result_vector); // Actual gridsearch calculation.
